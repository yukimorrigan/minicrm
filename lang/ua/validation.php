...
return [
    ...
    */
    ...
    'confirmed' => 'Поля ":attribute" та "Підтвердьте :attribute" не співпадають.',
    ...
    'dimensions' => ':attribute має не ті розміри зображення.',
    ...
    'min' => [
        ...
        'string' => 'Поле ":attribute" повинне складати не менше ніж :min символів.',
    ],
    ...
    'string' => 'Поле :attribute обов\'язкове для заповнення.',
